<!DOCTYPE html>
    ...
    <head>
        ...
        <title>{{ __('lines.page_title', ['teamName' => $teamName]) }}</title>
            ...
            <div class="row" id="form_container">
                <div class="col-md-6 col-md-offset-3">
                    <form id="request_form">
                        ...
                        <hr>
                        <h1>{{ __('lines.claim') }}</h1>
                        <p>{!!  __('lines.message', ['usersCount' => $usersCount, 'teamName' => $teamName]) !!}</p>
                        <hr>
                        <p><input type="text" class="form-control" id="email" placeholder="{{ __('lines.email') }}" autofocus required /></p>
                        <hr>
                        <p><button type="submit" class="btn btn-success form-control" id="send_button"><b>{{ __('lines.button.idle') }}</b></button></p>
                    </form>
                </div>
            </div>
